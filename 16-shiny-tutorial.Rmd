...
```{r}
covid_data <- read_csv("/home/deepak/Desktop/Research/stat220/MyStat220/ShinyApps/covid_confirmed_usafacts.csv")
head(covid_data)
```
...
4. Render a `geom_point` plot that gives the a trend of case count over time. Pass the filtered data to the plotting function.
